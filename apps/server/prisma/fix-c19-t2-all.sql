-- ============================================
-- C19 Test 2 Listening (STRICTLY from screenshots)
-- ============================================
...
VALUES (1902, '剑桥雅思 19 - Test 2 听力', 'listening', TRUE, 'intermediate', 40, 4, 30, NULL, TRUE, NOW(), NOW());
...
(19021,1,'fill_blank','Surname: ______',NULL,'Mathieson',1,NOW()),
(19021,2,'fill_blank','The group is aimed mainly at: ______',NULL,'beginners',1,NOW()),
(19021,3,'fill_blank','The meetings take place at the: ______',NULL,'college',1,NOW()),
(19021,4,'fill_blank','They are currently learning the: ______ programme',NULL,'New',1,NOW()),
(19021,5,'fill_blank','Meetings on Saturdays at: ______ a.m.',NULL,'11',1,NOW()),
(19021,6,'fill_blank','Each member needs to bring their own: ______',NULL,'instrument',1,NOW()),
(19021,7,'fill_blank','Beginners mainly learn by: ______',NULL,'ear',1,NOW()),
(19021,8,'fill_blank','They also do ______ exercises to improve rhythm',NULL,'clapping',1,NOW()),
(19021,9,'fill_blank','Members can take home a ______ of the sessions',NULL,'recording',1,NOW()),
(19021,10,'fill_blank','She decides to go and try it ______ before joining',NULL,'alone',1,NOW());

-- ============ Part 2: Lifeboat Volunteer ============
INSERT INTO IELTSExamSection (id, examId, sectionIndex, title, instructions, createdAt) VALUES
(19022, 1902, 2, 'Part 2', 'Questions 11-16: Choose the correct letter, A, B or C.\nQuestions 17-20: Choose TWO letters, A-E.', NOW());
INSERT INTO IELTSQuestion (sectionId, questionIndex, questionType, questionText, options, correctAnswer, score, createdAt) VALUES
...
(19022,14,'multiple_choice','How quickly can the lifeboat be launched?','["A. 3-5 minutes","B. 6-8 minutes","C. 10-12 minutes"]','B. 6-8 minutes',1,NOW()),
(19022,15,'multiple_choice','What does the Operations Manager decide?','["A. who to include in the crew","B. which training is needed","C. if the lifeboat should be launched"]','C. if the lifeboat should be launched',1,NOW()),
...
INSERT INTO IELTSExamSection (id, examId, sectionIndex, title, instructions, createdAt) VALUES
(19023, 1902, 3, 'Part 3', 'Questions 21-24: Choose TWO letters, A-E.\nQuestions 25-28: Choose the correct letter, A-E.\nQuestions 29-30: Choose the correct letter, A, B or C.', NOW());
INSERT INTO IELTSQuestion (sectionId, questionIndex, questionType, questionText, options, correctAnswer, score, createdAt) VALUES
...
(19023,25,'multiple_choice','Reason: a pair of boots','["A. one shoe was missing","B. the colour of one shoe had faded","C. one shoe had a hole in it","D. the shoes were of poor quality","E. the shoes were too dirty"]','E. the shoes were too dirty',1,NOW()),
(19023,26,'multiple_choice','a pair of black shoes','["A. one shoe was missing","B. the colour of one shoe had faded","C. one shoe had a hole in it","D. the shoes were of poor quality","E. the shoes were too dirty"]','B. the colour of one shoe had faded',1,NOW()),
(19023,27,'multiple_choice','a pair of trainers','["A. one shoe was missing","B. the colour of one shoe had faded","C. one shoe had a hole in it","D. the shoes were of poor quality","E. the shoes were too dirty"]','A. one shoe was missing',1,NOW()),
(19023,28,'multiple_choice','a pair of shoes','["A. one shoe was missing","B. the colour of one shoe had faded","C. one shoe had a hole in it","D. the shoes were of poor quality","E. the shoes were too dirty"]','C. one shoe had a hole in it',1,NOW()),
