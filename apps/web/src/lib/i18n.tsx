...
const zh: Record<string, string> = {
  ...
  'home.subtitle': '阅读文章、积累词汇、模拟雅思——一站式英语学习平台',
  'home.browse': '浏览文章',
  'home.cta_logged': '开始阅读',
  'home.cta_guest': '免费注册',

  'home.f1_title': '文章阅读',
  'home.f1_desc': '精选优质英文文章，点击任意单词即可查看音标、释义和例句，支持短语查询。',
  'home.f2_title': '智能背单词',
  ...
  'vocab.total': '共 {n} 个单词',
  'vocab.empty': '暂无单词',
  'vocab.empty_manual': '暂无手动添加的单词',
  'vocab.empty_manual_hint': '去阅读文章，点击单词加入生词本吧',
  'vocab.empty_studied': '暂无背过的单词',
  'vocab.empty_studied_hint': '去学习词书，点击"认识"即可记录',
  ...
  'vocab.know': '认识',
  'vocab.dont_know': '不认识',
  'vocab.tap_flip': '点击卡片查看详情',
  'vocab.type_hint': '输入剩余字母，退格删除',
  'vocab.study_hint': '点击"认识"才算背过单词哦~',
  'vocab.spell_hint': '拼写成功才算背过单词哦~',
  'vocab.correct': '正确！',
  'vocab.wrong': '正确答案是：',
  'vocab.next_word': '下一个 →',
  ...
  'vocab.col_index': '序号',
  'vocab.col_word': '单词',
  'vocab.col_phonetic': '音标',
  'vocab.col_part': '词性',
  'vocab.col_translation': '释义',
  ...
  'articles.title': '文章阅读',
  'articles.desc': '通过原汁原味的英文文章，在真实语境中提升词汇量',
  'articles.empty': '暂无文章',
...
const en: Record<string, string> = {
  ...
  'home.subtitle': 'Read articles, build vocabulary, and ace the IELTS — all in one place.',
  'home.cta_logged': 'Start Reading',
  'home.cta_guest': 'Get Started Free',
  'home.browse': 'Browse Articles',

  'home.f1_title': 'Article Reading',
  'home.f1_desc': 'Read quality English articles. Click any word for instant translation, phonetics, and examples.',
  ...
  'vocab.total': '{n} words',
  'vocab.empty': 'No words',
  'vocab.empty_manual': 'No manually added words',
  'vocab.empty_manual_hint': 'Read articles and click words to add them',
  'vocab.empty_studied': 'No studied words yet',
  'vocab.empty_studied_hint': 'Study a word book and click "Know It" to record',
  ...
  'vocab.tap_flip': 'Tap card to view details',
  'vocab.type_hint': 'Type the remaining letters, Backspace to delete',
  'vocab.study_hint': 'Only clicking "Know It" counts as studied~',
  'vocab.spell_hint': 'Only spelling correctly counts as studied~',
  ...
  'vocab.col_index': '#',
  'vocab.col_word': 'Word',
  'vocab.col_phonetic': 'Phonetic',
  'vocab.col_part': 'Part',
  'vocab.col_translation': 'Translation',
