...
const zh: Record<string, string> = {
  ...
  'vocab.study_hint': '点击"认识"或拼写成功才算背过单词哦~',
  'vocab.correct': '正确！',
  'vocab.wrong': '正确答案是：',
  'vocab.next_word': '下一个 →',
...
const en: Record<string, string> = {
  ...
  'vocab.remove': 'Remove',
  'vocab.prev_word': 'Previous',
  'vocab.next_word': 'Next',
  ...
  'vocab.study_hint': 'Only clicking "Know It" or spelling correctly counts as studied~',
